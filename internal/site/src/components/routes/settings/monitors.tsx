	...
	return (
		<div>
			<div>
				...
				<p className="text-sm text-muted-foreground leading-relaxed">
					<Trans>
						Latency is measured via a TCP connection to the configured port, not ICMP. A host that is reachable but has
						the port closed or filtered will show 100% loss.
					</Trans>
				</p>
			</div>
